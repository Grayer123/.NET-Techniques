...
namespace PersonLibrary
{
    public class PersonLong {
        ...
        public static List<PersonLongEntity> GetPersonLong(int age) {
            string connectString = ConfigurationManager.ConnectionStrings["DBCS2"].ConnectionString;
            List<PersonLongEntity> lst = new List<PersonLongEntity>();
            ...
            using (SqlConnection con = new SqlConnection(connectString)) {
                ...
                try {
                    ...
                    if (outParm.Value != null) {
                        PersonLongEntity.Dates = Convert.ToDateTime(outParm.SqlValue.ToString()).ToShortDateString();
